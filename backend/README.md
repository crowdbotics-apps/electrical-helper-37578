...
## Project Structure
    ...
    ├── electrical_helper_37578  # Django project configurations
...
1. Clone this repo and `cd electrical_helper_37578`
...
2. Clone this repo and `cd electrical_helper_37578`
